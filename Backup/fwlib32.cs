...
public class Focas1
{
	...
	[StructLayout(LayoutKind.Sequential,Pack=4)]
		public class OFS_3
	{
		[MarshalAs(UnmanagedType.ByValArray,SizeConst=4*400)]
		public int[]   m_ofs_c = new int[1600];   /* M-C All */
	} /* In case that the number of data is 5 */
	[StructLayout(LayoutKind.Sequential,Pack=4)]
		...
		public class IODBPI
	{
		...
		public sbyte[] data = new sbyte[1024];    /* offset value */
	} /* In case that the number of data is 5 , Modified to 1024 by CHChen*/
	...
	[DllImport("FWLIB32.dll", EntryPoint="cnc_rdparar")]
	public static extern short cnc_rdparartest( ushort FlibHndl,
		ref short a, short b, ref short c, ref short d, [Out,MarshalAs(UnmanagedType.AsAny)] Object e );
	...
	[DllImport("FWLIB32.dll", EntryPoint="cnc_rdprogdir2")]
	public static extern short cnc_rdprogdirTest( ushort FlibHndl,
		short a, ref short b, ref short c, [In,Out] PRGDIRTEST [] d );
